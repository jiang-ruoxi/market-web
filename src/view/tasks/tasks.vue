    ...
    <div>
        ...
        <div class="gva-table-box">
            ...
            >
                ...
                <el-table-column align="left" label="编号" prop="ID" width="90" sortable/>
                <el-table-column align="left" label="任务名称" prop="title" width="200" :show-overflow-tooltip='true'/>
                <el-table-column align="center" label="工种类型" prop="tagId" width="120">
        ...
        <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情"
            ...
            <el-scrollbar height="380px">
                <el-descriptions column="1" border>
                    ...
                    <el-descriptions-item label="工种类型">
                    ...
                    <el-descriptions-item label="招聘状态">
                        ...
                        <el-tag type="warning" v-if="formData.status==0">待审核</el-tag>
                        <el-tag type="primary" v-if="formData.status==1">招聘中</el-tag>
