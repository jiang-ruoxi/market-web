<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="banner名称" prop="name" width="120" />
        <el-table-column align="left" label="banner链接" prop="image" width="120" />
        ...
        <el-table-column align="left" label="操作" min-width="120">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateBannersFunc(scope.row)">变更</el-button>
